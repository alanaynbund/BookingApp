...
const PropertyList = () => {
    return (
        <div className="pList">
            ...
            <div className="pListItem">
                <img 
                src="https://q-xx.bstatic.com/xdata/images/xphoto/263x210/119467716.jpeg?k=63b69100225782d08fbd4d0205bf949c0be894ab946a0366edb8ad48e9c0ef46&o=" 
                alt=""
                className="pListImg" 
                />
                <div className="pListTitles">
                    <h1>Apartments</h1>
                    <h2>170 Apartments</h2>
                </div>
            </div>
            <div className="pListItem">
                <img 
